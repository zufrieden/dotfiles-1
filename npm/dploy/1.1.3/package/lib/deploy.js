(function() {
  var Deploy, FTP, SFTP, Signal, YAML, colors, exec, expand, fs, minimatch, path, prompt,
  ...
  module.exports = Deploy = (function() {
    ...
    */
    ...
    function Deploy(config, server, ignoreInclude) {
      this.config = config;
      this.server = server;
    ...
    */
    ...
    Deploy.prototype.setupServer = function() {
      var _this = this;
      this.connection = this.config.scheme === "sftp" ? new SFTP() : new FTP();
    ...
    */
    ...
    Deploy.prototype.setupMultipleServers = function() {
      var con,
        _this = this;
      con = this.config.scheme === "sftp" ? new SFTP() : new FTP();
